...
public function calculNbTotalFiche ($mois)
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'SELECT count(*)'
             .'from fichefrais '
...
public function calculFicheVa($mois)
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'SELECT count(*)'
             .'from fichefrais '
 ...
 public function insertBdd($pourcentage)
 {
   $requetePrepare = PdoGsb::$monPdo->prepare(
     'update pourcentage '
     .'set valeur = :unPourcentage'
            );
      $requetePrepare->bindParam(':unPourcentage', $pourcentage, PDO::PARAM_STR);
      $requetePrepare->execute();
